  ...
  if($template==2){   
     ...
     $content .= ' <table>
      <tr class="header_view"   style="background-color:'.$color.'">
        ...
        <img src="'.$this->session->userdata('image_email').'" width="90px" />
       </td>
       ...
       <td style="border: none; text-align: left; color: white"><b>Company Name</b>:'.$company_info[0]['company_name'].'<br><b>Email</b>:'.$company_info[0]['email'].'<br><b>Number </b>:'.$company_info[0]['mobile'].'<br><b>Address</b>:'.$company_info[0]['address'].'</td>
...
<tr>
<td style="border: none; font-size: 14px;"><b>Port Of Discharge:</b>&nbsp;<span style="font-weight: normal;">'.$invoice[0]['Port_of_discharge'].'</span></td>
</tr>
...
elseif($template==3)
{
  ...
  <tr class="header_view"  style="background-color:'.$color.'">
    ...
    <td style="border: none; text-align: right; color: white">'. $head[0]['header'].'</td>
